            ...
            navigate("/listingpage2")}
                ...
                <div className='w-[90%] flex items-start justify-start flex-col gap-[10px] '>
                  ...
                  <div className='w-[90%] flex items-start justify-start flex-col gap-[10px] '>
                    ...
                    <textarea name="" id="desc" className='w-[90%] h-[80px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px]' required  onChange={(e)=>setDescription(e.target.value)} value={description}/>
                </div>
                ...
                <div className='w-[90%] flex items-start justify-start flex-col gap-[10px] '>
                 ...
                 <button className='px-[50px] py-[10px] bg-[#f14242] rounded-2xl text-[white] text-[18px] md-px-[100px]'>Next</button>
